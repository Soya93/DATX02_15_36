...
public class CalendarView extends ActionBarActivity implements WeekView.MonthChangeListener,
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        Toast.makeText(CalendarView.this, "Clicked " + event.getName(), Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onEventLongPress(WeekViewEvent event, RectF eventRect) {
        Toast.makeText(CalendarView.this, "Long pressed event: " + event.getName(), Toast.LENGTH_SHORT).show();
    }
}
