    ...
    public void initCheckbox(){
        this.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (buttonView.isChecked()) {
                    ...
                    handInDB.setDone(getAssignmentCheckBox().getIdNr());
                }
                else{
                    ...
                    handInDB.setUndone(getAssignmentCheckBox().getIdNr());
                }
        ...
        getAssignmentCheckBox().setOnLongClickListener(new View.OnLongClickListener() {
            public boolean onLongClick(View arg0) {
                ...
                PopupMenu popup = new PopupMenu(HandInCheckBox.this.getContext(), getAssignmentCheckBox());
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        handInDB.deleteAssignment(getAssignmentCheckBox().getIdNr());
                        ...
                        assignmentCheckBoxLayout.addHandInsFromDatabase(courseCode, handInDB);

                        if(assignmentCheckBoxLayout.isEmpty()){
                            TextView textView = new TextView(getContext());
                            textView.setText("Du har för närvaranade inga " + AssignmentType.HANDIN.toString().toLowerCase() + " för den här kursen, lägg till en uppgift genom att fylla i informationen ovan och trycka på spara-knappen i övre högra hörnet");
